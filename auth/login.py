...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="-280.0 -280.0 560 560" width="120" height="120">
  ...
  <g>
    <rect x="-44.0" y="-230.0" width="88" height="50" rx="12"
          fill="#ffffff" stroke="#e4572e" stroke-width="3"/>
    <rect x="-44.0" y="-230.0" width="10" height="50" rx="5" fill="#e4572e"/>
    <text x="5.0" y="-205.0" font-family="Segoe UI, Arial, sans-serif"
          font-size="21" font-weight="800" fill="#e4572e"
          text-anchor="middle" dominant-baseline="central">PDF</text>
  </g>
  <g>
    <rect x="151.0" y="-88.3" width="88" height="50" rx="12"
          fill="#ffffff" stroke="#5b8def" stroke-width="3"/>
    <rect x="151.0" y="-88.3" width="10" height="50" rx="5" fill="#5b8def"/>
    <text x="200.0" y="-63.3" font-family="Segoe UI, Arial, sans-serif"
          font-size="21" font-weight="800" fill="#5b8def"
          text-anchor="middle" dominant-baseline="central">XML</text>
  </g>
  <g>
    <rect x="76.5" y="140.8" width="88" height="50" rx="12"
          fill="#ffffff" stroke="#1e9e63" stroke-width="3"/>
    <rect x="76.5" y="140.8" width="10" height="50" rx="5" fill="#1e9e63"/>
    <text x="125.5" y="165.8" font-family="Segoe UI, Arial, sans-serif"
          font-size="21" font-weight="800" fill="#1e9e63"
          text-anchor="middle" dominant-baseline="central">XLSX</text>
  </g>
  <g>
    <rect x="-164.5" y="140.8" width="88" height="50" rx="12"
          fill="#ffffff" stroke="#6b7280" stroke-width="3"/>
    <rect x="-164.5" y="140.8" width="10" height="50" rx="5" fill="#6b7280"/>
    <text x="-115.5" y="165.8" font-family="Segoe UI, Arial, sans-serif"
          font-size="21" font-weight="800" fill="#6b7280"
          text-anchor="middle" dominant-baseline="central">TXT</text>
  </g>
  <g>
    <rect x="-239.0" y="-88.3" width="88" height="50" rx="12"
          fill="#ffffff" stroke="#9b5de5" stroke-width="3"/>
    <rect x="-239.0" y="-88.3" width="10" height="50" rx="5" fill="#9b5de5"/>
    <text x="-190.0" y="-63.3" font-family="Segoe UI, Arial, sans-serif"
          font-size="21" font-weight="800" fill="#9b5de5"
