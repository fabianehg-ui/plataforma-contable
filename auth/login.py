...
def login_form():
    ...
    # Cabecera con logo
    st.markdown(
        f"<div class='ig-hero'><img class='ig-logo' src='{_LOGO_DATA_URI}' "
        "width='120' height='120' alt='INTEGRAL'/>"
